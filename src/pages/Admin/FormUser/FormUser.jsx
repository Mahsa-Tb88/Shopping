    ...
    <form className=" ms-3  mt-5" onSubmit={handleSubmit(onSubmit)}>
      <div className="table">
        <div className="d-flex flex-column justify-content-center align-items-start mb-4">
          ...
          />
          {errors.firstname && (
            <p className="errors mt-3 fs-5">{errors.firstname.message}</p>
          )}
        </div>
        ...
        <div className="d-flex flex-column justify-content-center align-items-start mb-4">
          ...
          />
          {errors.username && (
            <p className="errors mt-3 fs-5">{errors.username.message}</p>
          )}
        </div>
        {user ? (
          ""
          ...
          <div className="d-flex flex-column justify-content-center align-items-start mb-4">
            ...
            />
            {errors.password && (
              <p className="errors mt-3 fs-5">{errors.password.message}</p>
            )}
          </div>
        )}
        ...
        <div className="d-flex flex-column justify-content-center align-items-start mb-4">
          ...
          {errors.role && (
            <p className="errors mt-3 fs-5">{errors.role.message}</p>
          )}
        </div>
        {isSubmitting ? (
          <button
